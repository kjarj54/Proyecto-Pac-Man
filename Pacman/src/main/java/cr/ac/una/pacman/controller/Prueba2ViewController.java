 ...
 * @author ANTHONY
 */
public class Prueba2ViewController extends Controller implements Initializable {
...
//        graficos = cvLaberinto.getGraphicsContext2D();
//
//        PacMan pacman = new PacMan(3, 0, "A", COLUMNS/ 2, ROWS / 2, 2, 1, "cr/ac/una/pacman/resources/PacMan.png");
//        juego = new Juego(pacman, ROWS, COLUMNS);
//        juego.generarLaberinto();
//
//        pintar();
